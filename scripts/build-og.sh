#!/usr/bin/env bash
# 从 site/og.html 与 site/icon-square.svg、site/public/favicon.svg 渲染位图产物。
#
# 需要 gstack browse（无头 Chromium）。产物已提交进仓库，只在改了源模板时才需要重跑。
#   site/public/og.png                1200x630  OG / Twitter 预览图
#   site/public/apple-touch-icon.png  180x180   iOS 主屏图标
#   site/public/favicon-32.png        32x32     旧浏览器兜底
#
# 源模板在 site/ 根目录（og.html、icon-square.svg），不随站点发布；
# favicon.svg 既是源又是发布物，所以在 public/ 里。
set -euo pipefail
